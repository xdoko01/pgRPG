...
ECHO Recreating JSON models in 'corset' folder
cd corset
call _recreate_json.bat
cd ..

ECHO Recreating JSON models in 'dress' folder
cd dress
call _recreate_json.bat
cd ..
...
ECHO Recreating JSON models in 'robes' folder
cd robes
call _recreate_json.bat
cd ..
...
ECHO Recreating JSON models in 'tunics' folder
cd tunics
call _recreate_json.bat
cd ..