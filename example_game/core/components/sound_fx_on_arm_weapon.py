''' Module "example_game.core.components.sound_fx_on_arm_weapon" contains
SoundFXOnArmWeapon component implemented as a SoundFXOnArmWeapon class.

Use 'python -m example_game.core.components.sound_fx_on_arm_weapon -v' to run
module tests.
'''
...
class SoundFXOnArmWeapon(Component):
    ''' Game plays sound effect upon arming the weapon.

    Used by:
        - GenerateSoundFXOnArmWeaponProcessor

    Examples of JSON definition:
        {"type" : "SoundFXOnArmWeapon", "params" : {"sound" : "explosion.wav"}}

    Tests:
        >>> c = SoundFXOnArmWeapon(**{"sound" : "explosion.wav"})
    '''

    __slots__ = ['sound']

    def __init__(self, *args, **kwargs):
        ''' Initiate values for the new SoundFXOnArmWeapon component.
