''' Module "pyrpg.core.ecs.components.sound_fx_on_creation" contains
SoundFXOnCreation component implemented as a SoundFXOnCreation class.

Use 'python -m pyrpg.core.ecs.components.sound_fx_on_creation -v' to run
module tests.
'''
...
class SoundFXOnCreation(Component):
    ...
    Used by:
        - GenerateSoundFXOnCreationProcessor

    Examples of JSON definition:
        {"type" : "SoundFXOnCreation", "params" : {"sound" : "explosion.wav"}}

    Tests:
        >>> c = SoundFXOnCreation(**{"sound" : "explosion.wav"})
    '''

    __slots__ = ['sound']

    def __init__(self, *args, **kwargs):
        ''' Initiate values for the new SoundFXOnCreation component.
