...
class Player:
	...
	'''
	def __init__(self, x, y, image, option='NO_CONVERT'):

		self.image = pygame.image.load(image)

		if option == 'CONVERT':
			self.image.convert()
		elif option == 'CONVERT_ALPHA':
			self.image.convert_alpha()
		elif option == 'CONVERT_AND_COLORKEY_NO_FLAG':
			self.image.convert()
			pygame.Surface.set_colorkey(self.image, pygame.Color((0,0,0)))
		elif option == 'CONVERT_AND_COLORKEY_WITH_FLAG':
			self.image.convert()
			pygame.Surface.set_colorkey(self.image, pygame.Color((0,0,0)), pygame.RLEACCEL)

		else:
			pass
			print(f'Passing converison of image')
...
if __name__ == "__main__":
	...
	# Initiate entities
	map = Map()
	player = Player(20, 30, image="experiments/scrolling/images/player2.png")
