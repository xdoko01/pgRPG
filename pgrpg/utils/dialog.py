''' Module for handling dialogs
    ...
    ----------------------------------------
    How dialogs are incorporated into pgrpg?
    ----------------------------------------
...
if __name__ == "__main__":
    ...
    try:
        with open('pgrpg/utils/dlg_example.json', 'r') as dlg_file:
    ...
    dlg_object = prepare_dlg_obj_from_data(dlg_data, img_path=Path('pgrpg/resources/images'), font_path=Path('pgrpg/resources/fonts'))
