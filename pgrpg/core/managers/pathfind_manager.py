''' For the module test run python -m pgrpg.core.managers.pathfind_manager -v
while being in the pgrpg root dictionary
'''
from enum import Enum
from collections import namedtuple
from pgrpg.core.pathfinding import BFS as BFSearch # available pathfinding searchs
