...
from pgrpg.core.config import FILEPATHS # ENTITY_PATH # for ENTITY_PATH
from pgrpg.core.config import MODULEPATHS # for COMPONENT_MODULE_PATH, PROCESSOR_MODULE_PATH
from pgrpg.core.config import pgrpg # for TIMED parameter

from pgrpg.core.ecs import Component
from pgrpg.functions import get_class_from_def
from pgrpg.functions import translate # for creation of the component
from pgrpg.functions import json_logic # for evaluating conditions for processor prerequisites
from pgrpg.functions import get_dict_params # for filling of template with variables
from pgrpg.functions import get_all_dict_values # for reinit oc components
