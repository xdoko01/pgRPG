...
from pgrpg.core.config import MODULEPATHS # for SCRIPT_MODULE_PATH - Path to the modules containing scripts
...
def execute_event_actions(event: Event, actions: any) -> None:
    """Translates expression using the  alias_to_entity dictionary
