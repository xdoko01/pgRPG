''' Module "pyrpg.core.ecs.components.new_flag_is_about_to_be_teleported_by" contains
NewFlagIsAboutToBeTeleportedBy component implemented as a NewFlagIsAboutToBeTeleportedBy class.

Use 'python -m pyrpg.core.ecs.components.new_flag_is_about_to_be_teleported_by -v' to run
module tests.
'''

from pyrpg.core.ecs.components.component import Component

class NewFlagIsAboutToBeTeleportedBy(Component):
    ...
    def __init__(self, teleport, dest_x, dest_y, dest_map, key=None):
        ''' Initiate value for the new NewFlagIsAboutToBeTeleportedBy component.
