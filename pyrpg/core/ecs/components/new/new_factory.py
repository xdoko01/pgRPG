''' Module "pyrpg.core.ecs.components.new_factory" contains
NewFactory component implemented as a NewFactory class.

Use 'python -m pyrpg.core.ecs.components.new_factory -v' to run
module tests.
'''

from pyrpg.core.ecs.components.component import Component

class NewFactory(Component):
    ''' NewFactory component enables creation of new entity based
    ...
    def __init__(self, *args, **kwargs):
        ''' Initiate values for the NewFactory component.
