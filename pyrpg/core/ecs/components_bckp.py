...
if __name__ != '__main__':
	import pyrpg.core.config.config as config  # For renderable component IMAGE_PATH
	import pyrpg.core.engine as engine # For checking the engine.alias_to_entity - if component has entity as a str as a parameter (HasInventory) + engine._maps
	import pyrpg.core.models.model as model # For cached animated model in RenderableModel entity
