        ...
        for ent, (damaging, collision) in self.world.get_components(components.Damaging, components.Collidable):
            ...
            for col_event_entity in collision.collision_events:
                ...
                self.world.add_component(col_event_entity,
                                         components.FlagAddDamage(damage=damaging.damage, src_entity=damaging.parent if damaging.parent is not None else ent))


'''
class CollisionDamageProcessorObsolete(esper.Processor):
