...
class NewGenerateCommandFromInputProcessor(esper.Processor):
    ...
    def process(self, *args, **kwargs):
        ...
        def _add_cmds_to_queue(cmd_list, ent, cmd_add_fnc):
            ''' Checks if entity is already part of the command. If not, fills owner of NewControllable entity.
            Further adds the command to the queue.

            Parameters:
                :param cmd_list: List of commands (tuples) defined in NewControllable component to be processed
                :type list:

                :param ent: Entity - owner of NewControllable component to be added as parameter to the command
                            in case that entity is not already part of the command parameters from NewControllable
                            component.
                :type ent: int
            ...
            for cmd in cmd_list:
                ...
                # Ensure that proper 'entity' is passed as a command parameter - owner of NewControllable component
