...
__all__ = [
    ...
    # NEW DEBUG SYSTEM
    ###
    'NewListComponentsProcessor',
    'NewDebugProcessorPerformanceProcessor',
...
PROC_DICT = {
    ...
    # NEW DEBUG SYSTEM
    ###
    'NewListComponentsProcessor' : NewListComponentsProcessor,
    'NewDebugProcessorPerformanceProcessor' : NewDebugProcessorPerformanceProcessor,
    ...
    'NewGenerateProjectileFactoryDataProcessor' : NewGenerateProjectileFactoryDataProcessor,

    ###
    # New FACTORY SYSTEM
    ###
    'NewPerformFactoryGenerationProcessor' : NewPerformFactoryGenerationProcessor,
    'NewRemoveFlagCreateFromFactoryProcessor' : NewRemoveFlagCreateFromFactoryProcessor,
