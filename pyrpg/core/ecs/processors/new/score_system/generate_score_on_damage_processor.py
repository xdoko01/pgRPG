...
from pyrpg.core.ecs.components.new.scorable_on_damage import ScorableOnDamage
...
class GenerateScoreOnDamageProcessor(Processor):
    ...
    the damage. The FlagAddScore is then added to the respective entity.
    ...
    def process(self, *args, **kwargs):
        ...
        for ent_damaged, (flag_was_damaged_by, scorable_on_damage) in self.world.get_components(FlagWasDamagedBy, ScorableOnDamage):
            ...
            for ent_damaging in flag_was_damaged_by.entities:
                ...
                self.world.add_component(ent_damaging, FlagAddScore(score=scorable_on_damage.score))
