...
class PrepareProjectileProcessor(esper.Processor):
    ...
    def process(self, *args, **kwargs):
        ...
        for ent, (has_weapon, renderable_model, position) in self.world.get_components(components.HasWeapon, components.RenderableModel, components.Position):
            ...
            if has_weapon.get_weapon_in_use() and renderable_model.action == self.world.component_for_entity(has_weapon.get_weapon_in_use(), components.Weapon).action and renderable_model.is_action_frame:
                ...
                # TODO - what would happen if generator entity is None??? will error occur?
