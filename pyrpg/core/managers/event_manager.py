...
def load_handler(handler_def: list) -> None:
    """Reads the definition of the handler on the input and registers it 
    to the _event_handlers dictionary.
        ...
        [ 
            "SCENE_START",
            {
                ...
                "actions": 	[
                    ...
                    "show_msg_window",
                    {
                        "html_text" : "Welcome to <b>%scene_id</b>.<br/>Your goal is to place all the cranes on the market spots."
                    }
                ]
            }
        ]
